...
"Middleman":http://middlemanapp.com/ is a static website generator I use to generate web app prototypes. Since it uses Ruby, Bundler, and Sprockets its fairly easy migrate work done in Middleman to Ruby on Rails.
...
To get Bower to play nice with Middleman first you need to install your Bower packages in root of your project. This will create a folder named bower_components. This folder won’t be in the Sprockets default search path, but it can be added by inserting the following line into config.rb
